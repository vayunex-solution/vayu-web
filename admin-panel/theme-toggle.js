...
const updateThemeIcon = (theme) => {
    ...
    if (iconEl) {
        iconEl.innerHTML = theme === 'light' ? sunSvg : moonSvg;
    }
    const mobileIconEl = document.getElementById('theme-icon-mobile');
    if (mobileIconEl) {
        mobileIconEl.innerHTML = theme === 'light' ? sunSvg : moonSvg;
    }
};
