(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[543],{543:function(e,t,i){"use strict";i.r(t);var r=i(7437),o=i(8906),s=i(2265),n=i(2079),a=i(1448);i(7064);let h={onSpeedUp:()=>{},onSlowDown:()=>{},distortion:"turbulentDistortion",length:400,roadWidth:10,islandWidth:2,lanesPerRoad:4,fov:90,fovSpeedUp:150,speedUp:2,carLightsFade:.4,totalSideLightSticks:20,lightPairsPerRoadWay:40,shoulderLinesWidthPercentage:.05,brokenLinesWidthPercentage:.1,brokenLinesLengthPercentage:.5,lightStickWidth:[.12,.5],lightStickHeight:[1.3,1.7],movingAwaySpeed:[60,80],movingCloserSpeed:[-120,-160],carLightsLength:[12,80],carLightsRadius:[.05,.14],carWidthPercentage:[.3,.5],carShiftX:[-.8,.8],carFloorSeparation:[0,5],colors:{roadColor:526344,islandColor:657930,background:0,shoulderLines:16777215,brokenLines:16777215,leftCars:[14177983,6770850,12732332],rightCars:[242627,941733,3294549],sticks:242627}};t.default=e=>{let{effectOptions:t=h}=e,i=(0,s.useRef)(null),u=(0,s.useRef)(null);return(0,s.useEffect)(()=>{if(u.current){u.current.dispose(),u.current=null;let e=i.current;if(e)for(;e.firstChild;)e.removeChild(e.firstChild)}let e={uFreq:{value:new n.Pa4(3,6,10)},uAmp:{value:new n.Pa4(30,30,20)}},r={uFreq:{value:new n.FM8(5,2)},uAmp:{value:new n.FM8(25,15)}},s={uFreq:{value:new n.FM8(2,3)},uAmp:{value:new n.FM8(35,10)}},l={uFreq:{value:new n.Ltg(4,8,8,1)},uAmp:{value:new n.Ltg(25,5,10,10)}},d={uFreq:{value:new n.FM8(4,8)},uAmp:{value:new n.FM8(10,20)},uPowY:{value:new n.FM8(20,2)}},c=e=>.5*Math.sin(e)+.5,p={mountainDistortion:{uniforms:e,getDistortion:`
          uniform vec3 uAmp;
          uniform vec3 uFreq;
    ...
    `,C=i.current;if(!C)return;let q={...h,...t,colors:{...h.colors,...t.colors}};q.distortion=p[q.distortion];let z=new g(C,q);return u.current=z,z.init(),()=>{u.current&&(u.current.dispose(),u.current=null)}},[t]),(0,r.jsx)("div",{id:"lights",ref:i,style:{width:"100%",height:"100%"}})}},7064:function(){}}]);