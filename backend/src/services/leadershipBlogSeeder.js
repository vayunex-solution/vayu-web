...
const leadershipBlogs = [
  {
    ...
    author: 'Ved Prakash',
    categoryName: 'Enterprise Engineering',
    categorySlug: 'enterprise-engineering',
    tags: ['Software Delivery', 'Project Governance', 'Enterprise Architecture', 'Full-Stack Development', 'Engineering Leadership'],
    featuredImage: 'https://www.vayunexsolution.com/images/people/ved-prakash.jpg',
    status: 'published',
    publishDate: new Date('2026-03-01T09:00:00.000Z'),
    ...
    content: `
      ...
      <p>Enterprise clients frequently request accelerated release schedules to capture immediate market opportunities. The role of the Project Head is to ensure that speed does not compromise reliability. By establishing robust automated regression testing and clear definition-of-done criteria, platforms like our proprietary SaaS products (<a href="https://www.vayunexsolution.com/products/jwelnex">Jwelnex ERP</a> and <a href="https://www.vayunexsolution.com/products/paynex">PayNex</a>) maintain production-grade reliability across rapid update cycles.</p>

      <h2>5. Summary & Engineering Leadership Perspective</h2>
      <p>Predictable enterprise delivery requires uniting high-caliber engineering talent with methodical leadership. To learn more about our engineering standards or discuss custom platform architecture, visit our <a href="https://www.vayunexsolution.com/people/ved-prakash/">leadership profile</a> or explore our <a href="https://www.vayunexsolution.com/services/web-development">enterprise engineering services</a>.</p>
    `
  },
  {
    ...
    categoryName: 'Systems Architecture',
    categorySlug: 'systems-architecture',
    ...
    featuredImage: 'https://www.vayunexsolution.com/images/people/sandeep-kumar.jpg',
    status: 'published',
    publishDate: new Date('2026-03-02T10:00:00.000Z'),
    ...
    content: `
      ...
      <p>In high-throughput platforms like our <a href="https://www.vayunexsolution.com/products/jwelnex">Jwelnex ERP</a>, multi-tenant database contention is the primary threat to availability. We address this through disciplined database engineering:</p>
      <ul>
      ...
      <p>True technical leadership is not about choosing the newest technology stack; it is about building dependable, elegant architectures that teams can maintain and scale for years without accumulating crippling technical debt. Discover our technical philosophy on <a href="https://www.vayunexsolution.com/people/sandeep-kumar/">Sandeep Kumar's leadership profile</a> or explore our <a href="https://www.vayunexsolution.com/services/ai-data-science">AI & data engineering capabilities</a>.</p>
    `
  }
];

async function seedLeadershipBlogs() {
  console.log('🌱 Starting Leadership Blogs Database Seed...');
  
  for (const blogData of leadershipBlogs) {
    try {
      // Find or create category
      let category = await prisma.category.findUnique({
        where: { slug: blogData.categorySlug }
      });
      ...
      if (existing) {
        // Update to ensure author and details are latest
        const updated = await prisma.blog.update({
          where: { id: existing.id },
          data: {
            title: blogData.title,
            author: blogData.author,
            excerpt: blogData.seoDescription,
        ...
        console.log(`🔄 Updated existing blog [${updated.id}]: "${updated.title}" by ${updated.author}`);
      } else {
        // Create new blog
        ...
        console.log(`✨ Created new blog [${created.id}]: "${created.title}" by ${created.author}`);
      }
    } catch (err) {
      console.error(`⚠️ Error seeding blog "${blogData.slug}":`, err.message);
    }
  }

  console.log('✅ Leadership Blogs Seed Complete!');
}
