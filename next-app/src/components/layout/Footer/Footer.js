...
const getProductLogo = (id) => {
  switch (id) {
    case 'paynex':
      return <img src={paynexLogo?.src || paynexLogo || '/images/paynex-logo.webp'} alt="" className="footer__product-logo" />;
    case 'socialnex':
      return <img src={socialnexLogo?.src || socialnexLogo || '/images/socialnex-logo.webp'} alt="" className="footer__product-logo" />;
    case 'schooldost':
      return <img src={schooldostLogo?.src || schooldostLogo || '/images/schooldost-logo.webp'} alt="" className="footer__product-logo" />;
    case 'jwelnex':
      return (
        ...
        <div className="footer__container">
          ...
          <div className="footer__brand">
            <Link to="/" className="footer__logo" aria-label="Vayunex Solution Home">
              <img src={vayunexLogo?.src || vayunexLogo || '/images/vayunex-logo.webp'} alt="Vayunex" className="footer__logo-img" />
