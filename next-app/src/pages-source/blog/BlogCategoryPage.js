...
const BlogCategoryPage = ({ slug: propSlug }) => {
    let slug = propSlug;
    try {
    ...
    return (
        <div className="blog-category-page inner-page" style={{ paddingTop: '100px', minHeight: '80vh', maxWidth: '1200px', margin: '0 auto', padding: '100px 2rem 50px' }}>
            <SEO 
