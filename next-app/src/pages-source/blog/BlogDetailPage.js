                            ...
                            <div className="blog-sidebar-sticky">
                                ...
                                <div className="sidebar-card">
                                    ...
                                    <ul className="sidebar-nav-list">
                                        <li><Link to="/services" className="sidebar-nav-link"><span className="nav-arrow">&#8594;</span> Our Services</Link></li>
                                        <li><Link to="/products" className="sidebar-nav-link"><span className="nav-arrow">&#8594;</span> Products</Link></li>
                                        <li><Link to="/about" className="sidebar-nav-link"><span className="nav-arrow">&#8594;</span> About Vayunex</Link></li>
                                        <li><Link to="/contact" className="sidebar-nav-link"><span className="nav-arrow">&#8594;</span> Contact Us</Link></li>
                                    </ul>
                                </div>
