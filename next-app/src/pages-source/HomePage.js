  ...
  <div className="hero-visual" aria-hidden="true">
    ...
    <div className="hv-card hv-card--float hv-card--left">
      <div className="hv-float-logo-wrapper">
        <img src={paynexLogo?.src || paynexLogo || '/images/paynex-logo.webp'} alt="PayNex Logo" className="hv-float-logo" />
      </div>
    ...
    <div className="hv-card hv-card--float hv-card--right">
      <div className="hv-float-logo-wrapper">
        <img src={socialnexLogo?.src || socialnexLogo || '/images/socialnex-logo.webp'} alt="SocialNex Logo" className="hv-float-logo" />
      </div>
      <div className="hv-float-text">
    ...
    <div className="hv-card hv-card--float hv-card--right-bottom">
      <div className="hv-float-logo-wrapper">
        <img src={schooldostLogo?.src || schooldostLogo || '/images/schooldost-logo.webp'} alt="SchoolDost Logo" className="hv-float-logo" />
      </div>
      <div className="hv-float-text">
