...
export default function InventoryNexPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'InventoryNex is currently in private pilot testing with select enterprise partners. You can request early access today for priority deployment and locked-in founder benefits.'
    }
  ];
  ...
  return (
    <div className="product-page inner-page">
      ...
      />
      <ProductSchema product={getProductById('inventorynex')} />
      ...
      <div className="container">
        ...
        <section style={{ textAlign: 'center', padding: '4rem 0 3rem' }}>
          <div className="badge-pill" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '6px 16px', background: 'rgba(139, 92, 246, 0.15)', border: '1px solid rgba(139, 92, 246, 0.3)', borderRadius: '9999px', color: '#a78bfa', fontSize: '0.85rem', fontWeight: 600, marginBottom: '1.5rem' }}>
          ...
          {/* Authentic Branded UI Composite */}
          <div style={{ maxWidth: '1020px', margin: '0 auto', borderRadius: '16px', overflow: 'hidden', border: '1px solid rgba(6, 182, 212, 0.25)', boxShadow: '0 25px 60px -15px rgba(0, 0, 0, 0.7), 0 0 35px rgba(6, 182, 212, 0.12)' }}>
            <img 
              src="/images/inventorynex-hero.webp" 
              alt="InventoryNex Multi-Warehouse Management Console" 
